      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#1e293b] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="bg-[#1e293b] w-full border rounded-md border-[#334155] focus:border-[#38bdf8] ring-0 outline-0 transition-all duration-300 px-3 py-2"
              type="text"
              maxLength="100"
              required={true}
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-blue-600 to-sky-400 px-5 md:px-12 py-2.5 md:py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
              role="button"
              disabled={true}
              opacity={0.5}
              title="Coming Soon"
