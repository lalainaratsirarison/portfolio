    ...
    <div id="skills" className="relative z-50 border-t my-12 lg:my-24 border-[#1e293b]">
      ...
      <div className="flex justify-center my-5 lg:py-8">
        <div className="flex  items-center">
          <span className="w-24 h-[2px] bg-[#1e293b]"></span>
          <span className="bg-[#1e293b] w-fit text-white p-2 px-5 text-xl rounded-md">
            Skills
          </span>
          <span className="w-24 h-[2px] bg-[#1e293b]"></span>
        </div>
        ...
        >
          {skillsData.map((skill, id) => (
            <div className="w-36 min-w-fit h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] cursor-pointer"
              key={id}>
              <div className="h-full w-full rounded-lg border border-[#1e293b] bg-[#0f172a] shadow-none shadow-gray-50 group-hover:border-blue-500 transition-all duration-500">
